              ...
              <form @submit.prevent="handleSubmit()" class="p-fluid">
                <div class="p-field">
                    ...
                    <div  style="text-align:left !important">
                      ...
                      :class="{
                        'p-error':
                          validationErrors.fromAccountNumber && submitted,
                      }"
                ...
                <div class="p-field">
                  <div class="p-float-label">
                    <InputText
                      id="toAccountNumber"
                      v-on:input="validate()"
                      v-model="data.toAccountNumber"
                      :class="{
                        'p-invalid':
                          validationErrors.toAccountNumber && submitted,
                      }"
                    />
                    <label
                      for="toAccountNumber"
                      ...
                      >Numéro de compte bénéficaire</label
                    >
                  </div>
                </div>
...
export default defineComponent({
  data() {
    return {
      data: { fromAccountNumber: null, amount: null },
      user: {},
      accounts: [],
      connectedUser: {},
      validationErrors: {},
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.loading = true;
      TransactionService.transfert(this.data)
        .then((res) => {
          console.log(res);
    ...
    validate() {
      ...
      const fields = ['fromAccountNumber', 'toAccountNumber', 'description', 'amount'];
      fields.forEach(f => {
        if (this.data[f]) {
    ...
    onFromAccountChange() {
        this.data.fromAccountNumber = this.selectedFromAccount.accountNumber;
        console.log(this.data.fromAccountNumber);
    },
